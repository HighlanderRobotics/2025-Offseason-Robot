  ...
  private final VoltageOut voltageOut = new VoltageOut(0.0).withEnableFOC(true);
    ...
    public ClimberIOReal() {
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(
            50.0, motorPositionRotations, appliedPivotVoltage);
    }

    @Override
    public void updateInputs(ClimberIOInputs inputs) {
        BaseStatusSignal.refreshAll(
        motorPositionRotations, appliedPivotVoltage);

        inputs.positionRotations = Rotation2d.fromRotations(motorPositionRotations.getValueAsDouble()); //TODO not sure how this works because there's the winch thing
